...
export default function LeafScannerArt() {
  return (
    <svg viewBox="0 0 320 260" className="h-full w-full" fill="none" role="img" aria-label="Leaf scanner illustration">
      <defs>
        {/* Vibrant sprout → forest emerald leaf gradient */}
        ...
        {/* Vivid ambient green glow — pops on bright surfaces */}
        <radialGradient id="scanAuraG" cx="0.5" cy="0.5" r="0.5">
          <stop offset="0" stopColor="#34d399" stopOpacity="0.55" />
          <stop offset="0.55" stopColor="#22c55e" stopOpacity="0.25" />
          <stop offset="1" stopColor="#22c55e" stopOpacity="0" />
        </radialGradient>
        {/* Warm sunshine accent halo for the disease-detection pulse */}
        <radialGradient id="amberHaloG" cx="0.5" cy="0.5" r="0.5">
        ...
        {/* Soft drop shadow for cards on light surface */}
      ...
      <ellipse cx="160" cy="130" rx="148" ry="126" fill="url(#scanAuraG)" />
      {/* Subtle warm amber halo (sunshine vitality) */}
      <ellipse cx="200" cy="100" rx="80" ry="70" fill="url(#amberHaloG)" />
      ...
      <g clipPath="url(#scanFrameClip)">
        ...
        {[82, 114, 146, 178, 210, 242].map((x) => (
          <line key={`v${x}`} x1={x} y1={FRAME.y} x2={x} y2={FRAME.y + FRAME.h} stroke="#10b981" strokeOpacity="0.07" />
        ))}
        {[70, 100, 130, 160, 190, 220].map((y) => (
          <line key={`h${y}`} x1={FRAME.x} y1={y} x2={FRAME.x + FRAME.w} y2={y} stroke="#10b981" strokeOpacity="0.07" />
        ))}
        ...
        <g>
          ...
          >
            ...
            <path d="M160 74 L160 190" stroke="#ecfdf5" strokeOpacity="0.75" strokeWidth="2.4" strokeLinecap="round" />
            <path
              ...
              strokeLinecap="round"
            />
            <path d="M160 196 C160 205 158 211 152 217" stroke="#064e3b" strokeWidth="3" strokeLinecap="round" />
          </motion.g>

          {/* Disease hotspots with glowing amber pulsing rings (sunshine accent) */}
          <motion.circle cx="186" cy="118" r="6.5" fill="#f59e0b" />
          <motion.circle cx="186" cy="118" r="10" fill="#facc15" fillOpacity="0.35" />
          <motion.circle
            cx="186"
            cy="118"
            stroke="#fbbf24"
          ...
          />
          <motion.circle cx="138" cy="146" r="4.5" fill="#f59e0b" fillOpacity="0.95" />
          <motion.circle cx="138" cy="146" r="8" fill="#facc15" fillOpacity="0.3" />
          <motion.circle
            cx="138"
            cy="146"
            stroke="#fbbf24"
      ...
      />
      <text x="97" y="65.5" fontSize="8" fontWeight="800" fill="#0f766e" letterSpacing="1.5" fontFamily="inherit">
        SCAN
      </text>
      ...
      >
        <rect x="238" y="8" width="62" height="24" rx="12" fill="rgba(255,255,255,0.85)" stroke="#E2F1E8" />
      ...
      <motion.g
        ...
        filter="url(#cardShadow)"
      >
        <rect x="10" y="202" width="92" height="24" rx="12" fill="rgba(255,255,255,0.85)" stroke="#E2F1E8" />
        <text x="56" y="217.5" textAnchor="middle" fontSize="9" fontWeight="800" fill="#0f766e" fontFamily="inherit">
          234 PATHS
        </text>
      </motion.g>
    </svg>
