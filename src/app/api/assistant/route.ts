  ...
  const sections = [
    ...
    diagnosis
      ...
      : hasImage
        ...
        : "",
    hasImage && diagnosis
      ? "افحص الصورة المرفقة بنفسك وقارن نتيجة الفحص الأولي أعلاه بما تراه فعلاً في الصورة، ثم أطلِق تقرير التشخيص النهائي المهيكل بناءً على حكمك (أكّد النتيجة أعلاه أو صحّحها)، مع خطة العلاج والوقاية — وقدّم كل ذلك بوصفه تحليلك أنت بصوت واحد دون ذكر «النموذج» كطرف منفصل."
      : "",
    message
